...
def trainer(rank, world_size):
    ...
    dataloader = DataLoader(dataset, batch_size=config.batch_size, sampler=sampler, drop_last=True, pin_memory=True, pin_memory_device=f"cuda:{rank}", num_workers=2, prefetch_factor=4)
